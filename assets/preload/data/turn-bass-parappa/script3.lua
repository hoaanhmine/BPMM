...
function onCreate()
	...
	makeLuaSprite('borderparappa', 'borderparappa', -130, 0)
    scaleObject('borderparappa', 1.0, 1.0);
	scaleObject('borderparappa', 1.05, 1.05);
    addLuaSprite('borderparappa', true)
	setLuaSpriteScrollFactor('borderparappa', 0.0, 0.0)
	...
	makeLuaSprite('youarep', 'no se codear/youarep', -410, 300);
	setScrollFactor('youarep', 1.0, 1.0);
	setObjectCamera('youarep', 'other')
	scaleObject('youarep', 1.0, 1.0);
	addLuaSprite('youarep', true);
	...
	setPropertyFromClass('GameOverSubstate', 'characterName', 'parappa-death');
	setPropertyFromClass('GameOverSubstate', 'deathSoundName', 'parappa_dead');
	setPropertyFromClass('GameOverSubstate', 'loopSoundName', 'parappa_loop');
	setPropertyFromClass('GameOverSubstate', 'endSoundName', 'parappa_confirm');
...
function onBeatHit()
	...
	if curBeat == 1 then
		doTweenX('youarepTweenY', 'youarep', 540, 0.5, 'cubeOut')
	  end
	  if curBeat == 4 then
		doTweenX('youarepTweenY', 'youarep', 1500, 0.5, 'cubeIn')
	  end
	  if curBeat == 6 then
		  setProperty('youarep.visible', false);
	  end
...
function onUpdatePost()
	...
	getProperty('score.y', 100)
	setProperty('playerStrum.y', 50)
